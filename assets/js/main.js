(function ($) {
  ...
  $(".single-gallery-item").hover(
    function () {
      $(".single-gallery-item").addClass("hover");
    },
    function () {
      $(".single-gallery-item").removeClass("hover");
    }
  );
  ...
  $(".software-integrations-list ul li").hover(
    function () {
      $(".software-integrations-list ul li").addClass("hover");
    },
    function () {
      $(".software-integrations-list ul li").removeClass("hover");
    }
  );
  ...
  $(".new-software-list ul li").hover(
    function () {
      $(".new-software-list ul li").addClass("hover");
    },
    function () {
      $(".new-software-list ul li").removeClass("hover");
    }
  );
...
// application
var speed = 60;
var p = document.querySelector(".sub-content-h2");
var delay = 1000;
